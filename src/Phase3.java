...
class Phase3{
	/**
	* <h1>max-flow min-cut algorithm</h1>
	* This class implements the max-flow min-cut algorithm for task 1  
	* Displays the flow augmentation path found and its capacity in each step 
	* Displays the maximum flow of the network, and the corresponding min-cut 
